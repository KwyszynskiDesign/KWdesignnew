...
| `portfolio.html` | Link nawigacyjny „O mnie", zmieniona linia roli w footerze, ujednolicone „~10 lat pracy zawodowej" (było: „Kilkanaście lat"), przebudowana kolejność Tier 1 (RazDwa → Power of Mind → Karoma → CyfraDruk), nowa sekcja „Design archive" (kwyszynski + Sir Roger, skrócone karty bez opisu/chipów), usunięty martwy komentarz o `savage.html`. |
